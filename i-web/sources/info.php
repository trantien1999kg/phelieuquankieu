...
function saveInfo(){
	...
	$file1=$_FILES['file1'];
	/*$_FILES là lấy những input của thg type là file bên item_add còn file1 là name và id của riêng mỗi đứa nó  */
	...
	if(!empty($file1)){
        ...
        if($file1['error']==0){
            ...
            $photo = $func->uploadImg(0,"photo1","",$file1,$folder,$com,$table['img-width'],$table['img-height'],$table['img-ratio'],$table['img-b']);
            
            $send['photo1'] = $photo['photo1'];
