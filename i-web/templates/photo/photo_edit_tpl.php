...
<form name="supplier" class="form" id="form-validate"
    action="index.html?com=photo&act=save<?php if($_GET['id']!='') echo'&id='. $_GET['id'];?><?php if($_GET['type']!='') echo'&type='. $_GET['type'];?><?php if($_GET['page']!='') echo'&page='. $_GET['page'];?>"
        ...
        <div class="oneOne">
            <div class="widget mtop0">
                ...
                <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                    ...
                    <div class="formRight">
                        <input type="text" data-validation="required" data-validation-error-msg="Tên không được để trống"  name="data[ten_<?=$k?>]" title="Nhập tên" id="ten_<?=$k?>"
                ...
                <div class="formRow lang_hidden lang_<?=$k?>  <?= ($k == 'vi') ? 'active': '' ?>">
                    ...
                    <div class="formRight">
                        <div class="mt10"><img src="<?=_upload_hinhanh.$item['photo_'.$k]?>" alt="NO PHOTO"
                                width="100" /></div>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <input data-validation="required" data-validation-error-msg="điện thoại không được để trống" type="text" id="code_pro" name="data[phone]" value="<?=$item["phone"]?>"
                ...
                <div class="formRow">
                    <label><?=_links?>: </label>
                    <div class="formRight">
                        <input data-validation="required" data-validation-error-msg="Link không được để trống"  type="text" id="price" name="data[link]" value="<?=@$item['link']?>"
