...
<form name="supplier" class="form form-validate"
            ...
            <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">
                ...
                <div class="formRight">
                    <input data-validation="required" data-validation-error-msg="Tên không được để trống" type="text"
                        name="data[ten_<?=$k?>]" title="Nhập tên danh mục" id="ten_<?=$k?>"
    ...
    <div class="<?=($GLOBAL[$com][$type]['full']==true) ? 'oneOne':'colRight' ?>">
        ...
        <div class="widget mtop0">
            ...
            <?php if($GLOBAL[$com][$type]['imgphu']==true){ ?>
            <div class="formRow">
                <label>Tải hình ảnh nền:</label>
                <div class="formRight">
        ...
        <div class="widget <?=($GLOBAL[$com][$type]['img']==true) ? 'mtop10':'mtop0'?>">
            ...
            <div class="formRow">
                <label>Title [ <?=$v?> ]: </label>
                <div class="formRight">
                    <input data-validation="required" data-validation-error-msg="Title không được để trống" type="text"
                        value="<?=@$seoDB['title_'.$k]?>" id="title" name="dataseo[title_<?=$k?>]"
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <textarea data-validation="required" data-validation-error-msg="Description không được để trống"
                        rows="4" cols="" title="Nội dung thẻ meta Description dùng để SEO" class="tipS input100"
