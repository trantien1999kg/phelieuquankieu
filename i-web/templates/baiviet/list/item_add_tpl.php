                ...
                <div class="widget mtop0">
                    ...
                    <div class="formRow">
                        ...
                        <div class="formRight">
                            ...
                            <div class="mt10"><img src="<?=_upload_baiviet.$item['banner']?>" alt="NO PHOTO"
                                    width="300" />
                    ...
                    <?php if($GLOBAL_LEVEL1[$com][$type]['thongso']==true){ ?>

                    <div class="formRow lang_hidden lang_<?=$k?> <?= ($k == 'vi') ? 'active': '' ?>">

                        <label><?=_thongso?> [<?=$v?>]</label>

                        <div class="formRight">

                            <div
                                <?php if($GLOBAL_LEVEL1['baiviet']['san-pham']['thongso-ckeditor']==true) echo 'class="ck_editor"'; ?>>

                                <textarea title="Nhập mô tả . " data-height="400" id="thongso_<?=$k?>"
                                    <?=($GLOBAL_LEVEL1[$com][$type]['thongso-ckeditor']==true) ? 'class="ck_editors"':'rows="8"' ?>
