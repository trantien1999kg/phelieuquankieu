<?php  if(!defined('_source')) die("Error");
    ...
    if(empty($id) && empty($idl) && empty($idc) && empty($idi) && empty($ids)){
        ...
        $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau , ten_$lang as ten from #_baiviet where hienthi=1 $combo and type=? $order_by limit $startpoint,$per_page",array($type));
